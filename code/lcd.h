...
#define LCD_I2C_ADR         0x78 // not sure about the >> 1)    // 7 bit slave-adress without r/w-bit
...
uint8_t displayBuffer[DISPLAY_HEIGHT/8][DISPLAY_WIDTH];
    ...
    void lcd_display_block(uint8_t x, uint8_t line, uint8_t width); // display (part of a) row
#endif
